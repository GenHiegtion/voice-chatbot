...
from src.tools.provider import get_order_tools
from src.tools.tool_context import sync_local_cart, tool_context
...
def create_order_agent_node(llm: BaseChatModel):
    ...
    async def order_agent_node(state: AgentState) -> dict:
        ...
        with tool_context(session_id, current_app_cart):
            sync_local_cart(session_id, current_app_cart)
